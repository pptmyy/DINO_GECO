...
def get_argparser():
    ...
    parser.add_argument("--grad_accum_steps", "--grad-accum-steps", default=1, type=_positive_int)
    ...
    parser.add_argument("--max-detections", default=16000, type=_positive_int)
    parser.add_argument("--nms-iou", default=0.30, type=_probability)
    parser.add_argument(
        "--nms-method",
        default="dense_soft",
        choices=["hard", "soft", "dense_soft"],
    )
    parser.add_argument("--soft-nms-sigma", default=0.5, type=_non_negative_float)
    parser.add_argument("--soft-nms-score-threshold", default=0.001, type=_non_negative_float)
    ...
    parser.add_argument("--adaptive-dense-score-ratio", default=0.35, type=_non_negative_float)
    parser.add_argument("--adaptive-sparse-nms-iou", default=0.25, type=_probability)
    parser.add_argument("--adaptive-dense-nms-iou", default=0.45, type=_probability)
    parser.add_argument("--adaptive-dense-candidate-threshold", default=128, type=_positive_int)
    parser.add_argument("--query-output-stride", default=4, type=int, choices=[2, 4, 8])
    parser.add_argument("--stride2-refinement", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--center-gaussian-head", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--center-gaussian-loss-coef", default=1.0, type=_non_negative_float)
    parser.add_argument("--center-gaussian-sigma", default=2.0, type=_non_negative_float)
    parser.add_argument("--num-prototypes", default=4, type=_positive_int)
    parser.add_argument("--prototype-pred-topk", default=32, type=_non_negative_int)
    parser.add_argument("--prototype-pred-score-threshold", default=0.5, type=_probability)
    parser.add_argument("--prototype-ema-momentum", default=0.9, type=_probability)
    parser.add_argument("--mutual-adapter-layers", default=1, type=_non_negative_int)
    parser.add_argument("--decoupled-heads", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--use-semantic-anchor", action=argparse.BooleanOptionalAction, default=False)
    ...
    parser.add_argument("--val-iou-threshold", default=0.5, type=_probability)
    parser.add_argument("--detection-metric-interval", default=1, type=_non_negative_int)
    parser.add_argument("--detection-gate-ratio", default=0.98, type=_probability)
    parser.add_argument("--allow-partial-load", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--allow-missing-coco", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument(
        "--exemplar-scale-mode",
        default="always",
